...
from io_utils.io_common import read_test_data_files
import pandas as pd
...
def sequential(start_date, end_date, config, name=''):
    ...
    #                                          parse_dates=['time'], date_parser=parse_date)
    ...
    currents_fieldset = FieldSet.from_netcdf(file_names, variables, dimensions, allow_time_extrapolation=True)
    # Reading waves
